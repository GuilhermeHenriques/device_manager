...
public interface IDeviceV1Controller {
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "New device object had been added on DB", response = DeviceModel.class),
      @ApiResponse(code = 500, message = "Service exception. Can be Runtime Java exception or a DeviceException", response = ExceptionModel.class)
  })
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "Device had been found", response = DeviceModel.class),
      @ApiResponse(code = 500, message = "Service exception. Can be Runtime Java exception or a DeviceException", response = ExceptionModel.class) })
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "Device had been updated", response = DeviceModel.class),
      @ApiResponse(code = 500, message = "Service exception. Can be Runtime Java exception or a DeviceException", response = ExceptionModel.class) })
  ...
  @ApiResponses(value = {
      @ApiResponse(code = 200, message = "List of devices", response = DeviceModel.class),
      @ApiResponse(code = 500, message = "Service exception. Can be Runtime Java exception or a DeviceException", response = ExceptionModel.class) })
